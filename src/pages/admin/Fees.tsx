...
import { birrInputFilter, fmtAmount, fmtETB, parseBirrToSantim } from '../../lib/money'
...
/**
 * The paper is `components/print/Receipt.tsx` — shared with the finance
 * officer's screen and the Print-Only Staff queue, and it renders whichever
 * layout the school picked in Print settings.
 */
