...
export default function StaffProfile() {
  ...
  return (
    <>
      <Link to="/admin/staff" className="no-print inline-flex items-center gap-1.5 text-soft font-display font-medium text-[13.5px] mb-4 hover:text-gold">
      ...
      {editing && <EditDetailsModal teacher={raw} onClose={() => setEditing(false)} onDeleted={() => navigate('/admin/staff')} />}
    </>
  )
}
